...
# Wordpress Demo Plugin (Started template for Plugin development) 
> **Note:** This repository contains the core code of demo plugin for WordPress (My starter template for WordPress plugin development)
...
## About The Project
WordPress is a free and open-source content management system written in PHP and paired with a MySQL or MariaDB database. Features include a plugin architecture and a template system, referred to within WordPress as Themes. In this project i have made 3 starter templates for WordPress plugin development.
### Built With
...
* Organized starter template for WordPress Plugin development
* Options API
* Settings API
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/Wordpress-Demo-Plugin.git
```
2. Make a zip file of desired plugin
3. Install plugin as like normal plugin. (Need to show your local path of the plugin's location)
